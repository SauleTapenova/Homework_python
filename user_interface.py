    ...
    while True:
        ...
        match actions:
            case "1":
                print_all()
            case "2":
                find_entry(input("Enter surname or IIN: "), read_all())
            case "3":
                add_entry(add_menu())
            case "4":
                print_all()
            ...
            case "5":
                del_entry(input("Enter surname or IIN: "))
            case "6":
                import_export_menu()
            case "7":
...
def add_menu():
    ...
    add_dict = {"id": "1", "name": "", "surname": "", "IIN": "", "description": ""}
    for i in add_dict:
        if i != "id":
...
def edit_menu():
    add_dict = {"1": "name", "2": "surname", "3": "IIN", "4": "description"}
